...
replace (
	...
	// Fix cherry-picked onto stolostron/prometheus branch cve-2026-42151/v0.48.1 — do not delete branch.
	github.com/prometheus/prometheus => github.com/stolostron/prometheus v0.0.0-20260805114039-08531774f9fc
